...
/*   Updated: 2021/05/08 15:15:21 by yekim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** show_message.c
*/
void				show_message(t_philo *philo, int status);
...
** do_die.c
*/
void				do_die(t_info *info, t_philo *philo);

/*
** run_routine.c
*/
void				*run_routine(void *philo);

/*
** take_fork.c
*/
void				take_fork(t_info *info, t_philo *philo);
void				return_fork(t_info *info, t_philo *philo);
